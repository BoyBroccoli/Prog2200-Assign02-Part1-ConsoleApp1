...
namespace Delegates
{
        ...
        public delegate void FeesDiscountDelegate(ref decimal theFee, bool m_isHighRisk);
        ...
        class Dest_Zone5 : ShippingDestination
        {
            ...
            {
                fee = price * 0.02m;
            // the 'm' in 0.02m stands for decimal since 'D/d' is taken already for double. 
            // source: https://stackoverflow.com/questions/977484/what-does-the-m-stand-for-in-c-sharp-decimal-literal-notation // 
        }
    }
}
